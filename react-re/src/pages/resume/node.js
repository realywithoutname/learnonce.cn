    ...
    return (
      <Container>
        ...
        <Abstract>
          ...
          <p>
            掌握JavaScript，CSS 2/3，HTML 4/5，熟练应用Vue技术栈，React技术栈，webpack，git等工具；熟悉NodeJS常用框架。
          </p>
          <p>
            尊重“编程解决问题，代码写给人看”的原则，一直以编写可维护性强的程序为目标。
          </p>
        </Abstract>
        <Projects>
          <h2>项目经验</h2>
          <ul>
            <li>
              ...
              <p>
                该项目为共享单车多级别用户管理平台，由我独立负责，使用vue技术栈+element-ui作为项目基础，历时一年，到目前维护着90+个组件。
                期间经过三次大型重构，提高了项目的复用性，降低了开发和维护成本。
              </p>

              <p>
                设计基于ACL的多级路由生成器，对导航提供权限控制，子路由控制，在导航开始时对用户访问权限进行控制。
                减轻在业务程序中进行权限控制（页面内不同操作权限需要独立配置），理论上可实现无限级别的权限用户登陆和无限的路由层级。
              </p>

              <p>
                开发基于配置的表单生成组件和table生成组件，以基于数据生成代替编码的方式，减少了编写相同模式的代码。
                使如表单，表格这样的需求完成变得简单快速，节约更多的时间关注业务实现。
                如一个过滤表单和一个表单组成的管理页面，HTML代码可能只需要几行(理想情况😁)。
              </p>
            </li>
            <li>
              ...
              <p>
                基于rollup开发小程序脚手架，以解决最初小程序发布时，IDE语法高亮，自动提示不完善，es6不支持给开发带来的不便。
                支持自动生成小程序特有的目录结构；以及生成基本小程序模版；html，css，es6到wxml，wxss，es5的转换。
              </p>
            ...
            <li>
              <h3><span className="project-name">翻译计划</span></h3>
              <p>
                <a href="http://www.justsoso.me/blog/58ce6434d306ed453d87de1e" target="_blank">XMLHttpRequest</a> 第一次翻译英文规范文档，目前为翻译完成状态，但是没有经过专业校对。
              </p>
              <p>
                <a href="http://www.justsoso.me/blog/58dd23ebcc11fd66b05d5a43" target="_blank">fetch</a> fetch 规范，本地翻译中，希望作为一个跟踪官方修改(github)的项目维护。
              </p>
              <p>
                <a href="https://github.com/realywithoutname/ECMAScript">ECMAScript® 2018 Language Specification</a> ECMAScript 官方规范翻译，目前进度为第七章，希望维持与官方修改进度相同。
              </p>
            </li>
          </ul>
        </Projects>
